...
```{r chap16_5}
Epi = TodasSp %>% 
  filter(Genus %in% c("Epipactis")) # Extraer las matrices de Epipactis en la base de datos.
...
### Determinar cuantas poblaciones se uso para la investigaciones
 ...
 - La cantidad de poblaciones por especies en la base de datos de COMPADRE. La mayoría de los estudios usaron una sola población, pero hay estudios que usaron hasta 18 poblaciones distintas. Estas poblaciones pudiese ser de diferentes publicaciones. 
