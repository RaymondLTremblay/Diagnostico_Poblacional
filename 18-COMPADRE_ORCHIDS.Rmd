...
```{r chap16_26}
names(x2)
x2_subset=index_O |> select(mat, Lon, Lat, OrganismType, SpeciesAccepted,Authors, Journal, DOI_ISBN )

x2df=as.data.frame(x2_subset)
write_csv(x2df, "Orchid_data_DOI.csv")
```
