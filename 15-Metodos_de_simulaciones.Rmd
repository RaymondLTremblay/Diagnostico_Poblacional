...
head(Serapia.eq) # vemos las primeras 6 simulaciones de los tamaños por etapa
...
Asumimos una probabilidad igual de selección por cada poblacion. Simulación de tamaño de poblacional por etapa de la vida para las poblaciones afectada de forma antropogénicas y naturales.
...
#### Comparación entre la variación espacial vs la variación temporal
...
Lo que se observa es que la variación temporal y la variación espacial es más o menos igual (el rango de variación), pero que hay menos variación temporal que espacial. Por lo menos para los datos seleccionado de [@pellegrino2014effects] la variación temporal no es tan importante como la variación espacial y solapa el lambda de 1, al contrario la variación espacial no solapa el lambda de 1 (ambos CI son menores de 1, sugiriendo una reducción posible de las poblaciones).
