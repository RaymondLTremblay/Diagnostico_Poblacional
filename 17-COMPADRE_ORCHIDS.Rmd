...
names(ALLSp) # Nombre de las variables en el archivo COMPADRE
...
Igualmente podemos evaluar cuantos distinctos autores son responsable de esas publicaciones. Un total de 37 autores unicos o en grupo son la fuente de esos articulos.  

ROBERTO:
HAY una manera de contabilizar los nombres especificos, no por grupo?
...
```{r}
library(WRS2)
source("/Users/rlt/Library/CloudStorage/Dropbox/GitHub_Dropbox_Drive/GitHub/Diagnostico_Poblacional/Diagnostico_Poblacional/Rallfun-v38.txt", chdir = T)
