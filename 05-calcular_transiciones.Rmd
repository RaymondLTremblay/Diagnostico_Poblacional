...
Orchis_ficticia_df$fertilidad<-0
projection.matrix(Orchis_ficticia_df, anio_1, anio_2, fertilidad, stages, TF=TRUE)
...
```{r}
projection.matrix(Orchis_ficticia_df, anio_1, anio_2, fertilidad, stages, TF=FALSE)
```
