...
# Lista completa de todos los trabajos dinámica poblacional en orquídea que han usado matriz {-}
...
"Orchis", "ustulata", "Si", "Si" , "-", "-", "-", "-","Needs to be digitized","@tali2002dynamics",
 ...
 "*Platanthera*", "*praeclara*", "Si", "Si" , "Si", "Si", "-", "-","Efecto abiótico y biótico", "@sieg1995influence",
...
## Lista parcial de especies de orquídeas que han sido estudiadas que no incluye matrices
