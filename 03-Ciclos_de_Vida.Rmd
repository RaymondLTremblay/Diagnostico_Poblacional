...
En trabajo de Waite y Hutchings 1991, se recolectaron datos de la etapa de plantas vegetativa, plantas con flores y latencia de un año y dos años, por consecuencia la historia de vida es representada por 4 etapas. Los datos provienen de la figura 1 y la tabla 3b (periodo de herbovoria por oveja) de la publicación de [@waite1991population]. En este caso, se hace unos análisis para determinar cual es la probabilidad que un individuo con latencia de múltiples años este vivo.

Nota que este caso el objetivo de la publicación era determinar la probabilidad de que un individuo con latencia de múltiples años este vivo.  Por consecuencia no incluye reproducción (nota que no hay linea amarilla). Las etapas que pasen a latente el próximo año son de color azul, los que se quedan en la misma etapa son de color roja, verde es de una etapa no latente.
...
NOta aqui podemos usar otro paquete 
