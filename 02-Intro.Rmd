...
En la revisión de literatura de Crawley [@crawley1990population] el menciona siete componentes de la biología de plantas que parecen ser consitente.  **SE Deberia poner 2-4 referencias para cada uno de estos puntos**.
 ...
 - Debido que las plantas son sedentarias la interacciones con sus vecinos más imediato es importante y que la cantidad de individuos en un que rodea una planta impacta su crecimiento, reproducción y supervivencia [@mitchell1987analysis; @pantone1992path; postma2021dividing]. En la revisión de literatura de Postma [@postma2021dividing] donde se evalua 334 experimentos, el meta-analisis de como la biomasa de la plantas y las caracteristica fenotipicas cambian. Se observa que al aumentar la densidad el tamaño de la plantas se reduce por la redución en numeros de talos y ramas, pero la altura de las plantas no es afectada.  
 - Los cambios sucesionales (en tiempo) puede ser la regla y no la excepción. Por consecuencia el reclutamiento en una parcela especifica puede ser muy variable en el tiempo.
 - El reclutamiento puede ser infrecuente, impredecible y variable en el tiempo. En adición como muchas especies produce bancos de semillas, el reclutamiento pudiese ser de semillas que han estado en el banco de semillas por muchos años.
 - La competencia entre plantas es importante y asimétrica, en otra palabra las plantas grandes pueden afectar las plantas pequeñas en su entorno, y raramente al reves.
